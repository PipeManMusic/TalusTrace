...
def test_ph5_1_1_bom_cut_length_accuracy():
    ...
    standard_wire = Wire(id="W1", type="STANDARD", path_nodes=path, source_pin_id="P1", target_pin_id="P2")
    # Twisted Pair: (1000mm * 1.05) + 50mm slack = 1100mm
    twisted_pair = Wire(id="W2", type="TWISTED_PAIR", path_nodes=path, source_pin_id="P1", target_pin_id="P2")
